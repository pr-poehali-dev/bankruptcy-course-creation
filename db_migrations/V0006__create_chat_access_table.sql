...
CREATE INDEX idx_chat_access_active ON chat_access(is_active, access_end);

-- Индекс для поиска по email и telegram
CREATE INDEX idx_chat_access_contacts ON chat_access(client_email, telegram_username);