        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <blockquote className="border-l-4 border-accent pl-6 italic text-lg text-muted-foreground">
              "Я создала этот курс, чтобы помочь людям самостоятельно пройти процедуру банкротства и не переплачивать юристам. Все знания, которые я накопила за годы практики, теперь доступны каждому."
            </blockquote>
          </div>
        </div>
      </div>
