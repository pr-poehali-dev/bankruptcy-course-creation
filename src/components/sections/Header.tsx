      ...
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-xs sm:text-sm text-primary/70">Арбитражный управляющий</span>
            <h1 className="text-base sm:text-xl font-bold text-primary">Валентина Голосова</h1>
          </div>
        </div>
